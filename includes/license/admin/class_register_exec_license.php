...
class Register_Exec_License {
	 ...
	 * @return static
	 */
	public static function instance( string $basename, string $version, object $config, Wp_Experience_Reports $main, string $plugin_dir ): self {
	 ...
	 */
	public function __construct( string $basename, string $version, object $config, Wp_Experience_Reports $main, string $plugin_dir ) {
